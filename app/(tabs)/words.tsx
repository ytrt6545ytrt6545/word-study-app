...
const styles = StyleSheet.create({
  ...
  actionButton: { paddingHorizontal: 8, paddingVertical: 6, backgroundColor: "#f0f0f0", borderRadius: 8, borderWidth: 1, borderColor: "#ddd", alignItems: "center", justifyContent: "center" },
